...
/**
 * Commit memory pages by giving a range of page indexes
 */
__wasi_errno_t __wasi_commit_pages(
    /**
     * Index of the first page to commit (included)
     */
    __wasi_size_t from,
    /**
     * Index of the page to stop to commit (excluded)
     */
    __wasi_size_t to
) __attribute__((__warn_unused_result__));
/** @} */
