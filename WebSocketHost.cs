...
namespace SharedCockpitClient
{
    ...
    public sealed class WebSocketHost : IDisposable
    {
        ...
        public void Start()
        {
            ...
            {
                server.Start();
                Console.WriteLine($"🛰️ Servidor WebSocket activo en ws://0.0.0.0:{server.Port}");
            }
        }
        ...
        public void Stop()
        {
            ...
            {
                server.Stop();
                Console.WriteLine("🛑 Servidor WebSocket detenido.");
            }
        }
        ...
        private sealed class HostBehavior : WebSocketBehavior
        {
            ...
            {
                base.OnOpen();
                Console.WriteLine("👥 Copiloto conectado al servidor WebSocket.");
            ...
            {
                base.OnClose(e);
                Console.WriteLine("👋 Copiloto desconectado del servidor WebSocket.");
